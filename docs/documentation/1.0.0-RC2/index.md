...
_This is the documentation for the version 1.0.0-RC2._
...
{% if "1.0.0-RC2" contains "SNAPSHOT" %}
...
-----
  ...
  Please refer to the [Javadoc](https://faustxvi.github.io/junit5-docker/javadoc/1.0.0-RC2) for more details.
